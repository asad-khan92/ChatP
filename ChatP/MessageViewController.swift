...
class MessageViewController: SLKTextViewController {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(UINib.init(nibName: "InCommingMessageCell", bundle: .main), forCellReuseIdentifier: "InCommingMessageCell")
        //self.tableView.register(InCommingMessageCell.classForCoder(), forCellReuseIdentifier: "InCommingMessageCell")
...
extension MessageViewController {
    ...
    override func didPressArrowKey(_ keyCommand: UIKeyCommand?) {
        ...
        if keyCommand.input == UIKeyInputUpArrow && self.textView.text.count == 0 {
    ...
    override func didChangeAutoCompletionPrefix(_ prefix: String, andWord word: String) {
        ...
        else if (prefix == ":" || prefix == "+:") && word.count > 0 {
...
extension MessageViewController {
    ...
    func messageCellForRowAtIndexPath(_ indexPath: IndexPath) -> InCommingMessageCell {
        
        //let cell = self.tableView.dequeueReusableCell(withIdentifier: MessengerCellIdentifier) as! MessageTableViewCell
         let cell = self.tableView.dequeueReusableCell(withIdentifier: "InCommingMessageCell") as! InCommingMessageCell
        ...
        cell.title.text = message.username
        cell.messageBody.text = message.text
        
        let image = UIImage(named: "InComming Bubble")!
        cell.messageBubble.image = image
            .resizableImage(withCapInsets:
                UIEdgeInsetsMake(17, 21, 17, 21),
                            resizingMode: .stretch)
            .withRenderingMode(.alwaysTemplate)
        
        cell.messageBubble.tintColor = UIColor(named: "chat_bubble_color_sent")
